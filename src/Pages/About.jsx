    ...
    <div>
        ...
        <div className='bg-richblack-800  ' >
            ...
            <div className=' relative flex flex-col items-center gap-12 w-11/12 max-w-maxContent mx-auto pt-20' >
                {/* headings and text */}
                <div className='flex flex-col gap-2 items-center w-[70%] text-center ' >
        ...
        {/* section 3 */}
        <div className='w-11/12 max-w-maxContent mx-auto flex flex-col gap-60 py-24 ' >
            {/* upper wala div */}
